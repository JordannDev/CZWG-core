...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'mentor'], function () {
        Route::get('/dashboard/trainingnotes', 'AtcTraining\TrainingNotesController@index')->name('trainingnotes.index');
        Route::post('/dashboard/trainingnotes/{note_id}/edit', 'AtcTraining\ApplicationsController@submitApplication')->name('application.submit');
    });
    ...
    Route::group(['middleware' => 'instructor'], function () {
        ...
        Route::get('/dashboard/trainingnotes/all', 'AtcTraining\TrainingNotesController@master')->name('trainingnotes.index');
        ...
        Route::post('/dashboard/roster/controller/add/', 'AtcTraining\RosterController@addController')->name('roster.addcontroller');
        Route::post('/dashboard/roster/controller/addv/', 'AtcTraining\RosterController@addVisitController')->name('roster.addvisitcontroller');
        Route::post('/dashboard/roster/edit/{id}', 'AtcTraining\RosterController@editController')->name('roster.editcontroller');
        Route::get('/dashboard/roster/edit/{id}', 'AtcTraining\RosterController@editControllerForm')->name('roster.editcontrollerform');
        Route::get('/dashboard/roster/{id}', 'AtcTraining\RosterController@viewController')->name('roster.viewcontroller');
        Route::get('/dashboard/roster/{id}/delete/', 'AtcTraining\RosterController@deleteController')->name('roster.deletecontroller');
    ...
    Route::group(['middleware' => 'staff'], function () {
        ...
        Route::get('/admin/news/article/delete/{id}', 'News\NewsController@deleteArticle')->name('news.articles.delete');
        Route::post('/admin/news/article/edit/{id}', 'News\NewsController@editArticle')->name('news.articles.edit');
        //Events
