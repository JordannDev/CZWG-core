...
//News Routes
  //STAFF
    Route::group(['prefix' => 'admin/news', 'middleware' => 'staff'], function () {
  ...
  Route::post('/article/edit/{id}', 'News\NewsController@editArticle')->name('news.articles.edit');
    ...
    Route::get('/dashboard/staff/tickets', 'Tickets\TicketsController@staffIndex')->middleware('staff')->name('tickets.staff');
      ...
      Route::group(['middleware' => 'staff'], function () {
          ...
          Route::get('/admin/feedback', 'Feedback\FeedbackController@index')->name('staff.feedback.index');
          Route::get('/admin/feedback/controller/{id}', 'Feedback\FeedbackController@viewControllerFeedback')->name('staff.feedback.controller');
          Route::get('/admin/feedback/website/{id}', 'Feedback\FeedbackController@viewWebsiteFeedback')->name('staff.feedback.website');

      Route::prefix('dashboard/tickets')->group(function() {
          Route::get('/{id}/close', 'Tickets\TicketsController@closeTicket')->name('tickets.closeticket');
          Route::get('/{id}/hold', 'Tickets\TicketsController@onholdTicket')->name('tickets.onholdticket');
          Route::get('/{id}/open', 'Tickets\TicketsController@openTicket')->name('tickets.onholdticket');
});
    ...
    //Event Routes
      ...
      Route::get('/roster/{id}/deletevisit/', 'AtcTraining\RosterController@deleteVisitController')->name('roster.deletevisitcontroller');
});
      //Email prefs
      ...
      Route::get('{id}', 'Users\UserController@viewUserProfile')->name('users.viewprofile');
