                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="list-group">
                                ...
                                @else
                                    @foreach ($unconfirmedapp as $uapp)
                                        @if ((substr($uapp->event_date, 5, 2)) == 01)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                January {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 02)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                February {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 03)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                March {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 04)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                April {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 05)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                May {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 06)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                June {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 07)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                July {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == '08')
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                August {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == '09')
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                September {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 10)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                October {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 11)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                November {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @elseif ((substr($uapp->event_date, 5, 2)) == 12)
                                            <br>  <h5><b>{{$uapp->event_name}}</b> starts
                                                at {{substr($uapp->event_date, 11, 5)}}z on
                                                December {{substr($uapp->event_date, 8, 2)}}
                                                , {{substr($uapp->event_date, 0, 4)}}</h5>
                                        @endif
                                        <li>
                                            <b>Time Available:</b> {{$uapp->start_availability_timestamp}}z
                                            - {{$uapp->end_availability_timestamp}}z <b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                Position Requested:</b> {{$uapp->position}}
                                        </li>
                                ...
                                <br><br>
                                <h3 class="font-weight-bold blue-text pb-2">Confirmed Event Slots</h3>
                                ...
                                @else
                                    @foreach ($confirmedevent as $cevent)
                                        @if ((substr($cevent->start_timestamp, 5, 2)) == 01)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                January {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 02)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                February {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 03)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                March {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 04)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                April {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 05)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                May {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 06)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                June {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 07)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                July {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == '08')
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                August {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == '09')
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                September {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 10)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                October {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 11)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                November {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @elseif ((substr($cevent->start_timestamp, 5, 2)) == 12)
                                            <br>  <h5><b>{{$cevent->name}}</b> starts
                                                at {{substr($cevent->start_timestamp, 11, 5)}}z on
                                                December {{substr($cevent->start_timestamp, 8, 2)}}
                                                , {{substr($cevent->start_timestamp, 0, 4)}}</h5>
                                        @endif
                                        @foreach ($confirmedapp as $capp)
                                            ...
                                            @if ($cevent->name == $capp->event_name)
                                                <li>
                                                    <b> Position:</b> {{$capp->position}}
                                                    from {{$capp->start_timestamp}}z - {{$capp->end_timestamp}}z
                                                </li>
                        ...
                        <ul class="list-unstyled mt-2 mb-0">
                            <li class="mb-2">
                                <a href="{{route('feedback.create')}}" style="text-decoration:none;"><span
                                        class="blue-text"><i class="fas fa-chevron-right"></i></span> &nbsp; <span
                                        class="black-text">Send feedback to staff</span></a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('tickets.index', ['create' => 'yes'])}}" style="text-decoration:none;"><span
                                        class="blue-text"><i class="fas fa-chevron-right"></i></span> &nbsp; <span
    ...
    <div class="modal fade" id="newStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('instructor.student.add')}}" class="form-group">
                        @csrf
