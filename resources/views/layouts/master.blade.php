...
<html lang="en">
    ...
    <header>
        <nav id="czwgHeader" class="navbar navbar-expand-lg navbar-dark p-0" style="min-height:59px; background-color:#013162">
            <div class="container">
                <a class="navbar-brand" href="{{route('index')}}"><img style="height: 40px; width:auto;" id="czqoHeaderImg" src="https://i.imgur.com/77XSFhQ.png" alt=""></a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown {{ Request::is('policies') || Request::is('meetingminutes') ? 'active' : ''}}">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown01">
                                ...
                                <a class="dropdown-item" href="https://blog.winnipegfir.ca">Blog</a>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="modal fade" id="discordTopModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Join the VATCAN discord!</h5><br>
                </div>
                <div>
                    <br>
                    <center><p>You can join the VATCAN discord by clicking <a href="https://vatcan.ca/my/discord/join" rel="noopener noreferrer" target="_blank">here!</a></p></center>
                </div>
            </div>
        </div>
    </div>
